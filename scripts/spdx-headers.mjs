...
const EXCLUDE_RE = [
  ...
  /\/docs\/api\/openapi\.html$/, // generated by `pnpm api:preview` (Redoc build), gitignored
  /\.gen\.go$/, // oapi-codegen output (committed; drift-checked in CI)
  /\/internal\/store\/gen\//, // sqlc output (committed; drift-checked in CI)
];
